export default class CommonConstants {
  ...
  static readonly WAIT = (() => {
      const waitTime = process.env.WAIT_TIME ? parseInt(process.env.WAIT_TIME, 10) : 5; // Default to 5 minutes if WAIT_TIME is not set
      return waitTime * CommonConstants.ONE_THOUSAND * CommonConstants.SIXTY;
  })();
}
